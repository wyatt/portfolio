...
const Work = () => {
	return (
		<>
			...
			<WorkGrid className={'animate__animated animate__delay-3s animate__zoomIn'}>
				<WorkItem
...
const WorkItemContainer = styled.a<WorkItemContainerTypes>`
	...
	height: 30vh;
	position: relative;
	${tw`text-white flex items-center justify-center font-semibold flex-col overflow-hidden rounded-xl transform hover:scale-105 transition ease-in-out duration-300`}
	&:hover {
		* > .letters {
